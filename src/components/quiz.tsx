...
return(
   <div>
    <div className={`${value==39?"invisible":"bg-gray-500 p-4 md:w-2/3 w-80 rounded-3xl h-max md:mx-64 md:my-32 m-4 flex md:flex-row flex-col "}`}>
            ...
            <div className={`${value!=39?"invisible":"absolute top-16 text-center bg-gray-500 md:p-10 p-1 md:w-2/3 w-80 rounded-3xl md:h-64 h-96 md:ml-44 m-2 ml-4 md:mt-32"}`}>
